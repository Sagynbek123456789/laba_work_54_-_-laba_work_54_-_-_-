...
from webapp.views import (products_view, product_view, product_add_view, category_add_view, product_update_view,
                          product_delete_view, products_definitely_category_view)
